...
<html lang="en">
  <head>
    <link href="https://fonts.googleapis.com/css2?family=Chelsea+Market&family=Roboto+Mono:ital,wght@0,700;1,400&display=swap" rel="stylesheet">
    ...
    <body>
      <header>
        <nav>
          <a href="#plan" class = "orange">Plan your<br> Visit</a>
          <a href="#learn" class = "blue">Learn about<br> the Park</a>
          <a href="#getinvolved" class = "yellow">Get<br> Involved</a>
        </nav>
      </header>
      <section class="cta">
        <div class="image">
      ...
      <section class="info">
        <div class="campfire">
          <img src="assets/campfire.png" alt="camp fire illustration">
        ...
        <div class="camper">
          <img src="assets/camper.png" alt="camper illustration">
